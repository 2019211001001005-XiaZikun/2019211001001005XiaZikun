<%@ page import="com.XiaZikun.lab1.Person" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="java.util.List" %>
<%@ page import="com.XiaZikun.lab1.Dog" %><%--
...
<ul>
    <c:forEach items="${words}" var="i" step="2">
        <li>${i}</li>
    </c:forEach>
</ul>
...
personList.add(new Person("Mike",new Dog("Mikey")));
...
<c:forEach items="${AllPerson}" var="person">
    <li>person:${person.name} and dog: ${person.dog.name}</li>
</c:forEach>
</ul>
<%
...
<c:forTokens items="one:two:three-four-five" delims=":-" var="number">
<li>
