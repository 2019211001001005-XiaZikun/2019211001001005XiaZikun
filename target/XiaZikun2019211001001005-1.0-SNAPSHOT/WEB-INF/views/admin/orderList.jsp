			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.XiaZikun.model.Order o=(com.XiaZikun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.XiaZikun.dao.UserDao userDao=new com.XiaZikun.dao.UserDao();
						...
						<%
							...
							String paymentType=com.XiaZikun.model.Payment.findByPaymentId(con,n);
							 %>
